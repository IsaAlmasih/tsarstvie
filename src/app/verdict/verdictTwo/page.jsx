            ...
            <HTMLFlipBook width={1200} height={700}>
              <div className={styles.firstPage}>
                <h4 className={styles.isava}>
                  2. Вторая книга. Вердикт два. Разводящиеся без вины
                  прелюбодеяния. Разведённые, без вины прелюбодеяния в ад.
                  Обручающиеся с разведёнными по вине прелюбодеяния, запрещено!
                  Рукоблудники, всяк извращённый, извращенец и сменивший пол,
                  горите там же где и убийцы. Священники освобождаются от
                  прощений всяких грехов.
                </h4>
