...
import styles from "../verdictTwo/stules.module.css";
  ...
  return (
    <div className={styles.wrapper}>
      <h4 className={styles.isava}>
        ...
        Разводящиеся без вины прелюбодеяния. Разведённые, без вины прелюбодеяния
        в ад. Обручающиеся с разведёнными по вине прелюбодеяния, запрещено!
        Рукоблудники, всяк извращённый, извращенец и сменивший пол, горите там
        же где и убийцы. Священники освобождаются от прощений всяких грехов.
      </h4>
