            ...
            <HTMLFlipBook width={1200} height={700}>
              <div className={styles.firstPage}>
                <h4 className={styles.isava}>
                  1. Первая книга. Вердикт один. Убийству нет прощения.
                  Противящийся злу, дополняет зло. Убийство во имя защиты,
                  правды, отечества, есть нарушение. Убийство во Имя Моё, есть
                  нарушение. Прощения за это нет и не будет. Простил убийство,
                  стал убийцей. Самоубийство - тоже убийство. Пособничество в
                  убийстве, убийство. Отправил убивать, стал убийцей. На земле
                  нет того, кто простит убийство!
                </h4>
